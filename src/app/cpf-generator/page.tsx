          ...
          <div className="flex items-start">
            ...
            <div className="ml-3">
              <h3 className="text-lg font-semibold text-amber-800 dark:text-amber-200 mb-2">
                Sobre o CPF e Cuidados Importantes
              </h3>
              <div className="text-amber-700 dark:text-amber-300 space-y-2">
                <p>
                  <strong>O que é CPF:</strong> O Cadastro de Pessoas Físicas (CPF) é um documento emitido pela Receita Federal do Brasil que serve para identificar os contribuintes brasileiros.
                </p>
                <p>
                  <strong>Para que usar CPFs gerados:</strong> Os CPFs gerados por esta ferramenta são apenas para fins de teste, desenvolvimento de software e demonstrações. Eles seguem o algoritmo oficial de validação.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="ml-3">
              ...
              <div className="text-red-700 dark:text-red-300 space-y-2">
                <ul className="list-disc list-inside space-y-1">
                  <li>
                    <strong>Nunca use para fins fraudulentos:</strong> É crime usar CPF de terceiros ou dados falsos em documentos oficiais.
                  </li>
                  <li>
                    <strong>Apenas para testes:</strong> Use exclusivamente para desenvolvimento, testes de software e demonstrações.
                  </li>
                  <li>
                    <strong>Não são CPFs reais:</strong> Embora sigam o algoritmo de validação, estes CPFs não pertencem a pessoas reais.
                  </li>
                  <li>
